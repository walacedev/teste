    ...
    <body id="page-top" style="background-image: url(../img/background.png)">
      ...
      <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <?php if ($usuario['cargo'] == "ADMIN") { ?>
          <li class="nav-item">
            <a class="nav-link" href="setlocal.php">
              <i class="fas fa-fw fa-users"></i>
              <span>Voltar para locais</span></a>
          </li>
          <?php } ?>
          ...
          <div id="content">
            ...
            <div class="container-fluid">
              ...
              if($usuario['cargo'] != "ADMIN"){
                if ($status != "ABERTO") {
                echo '<a href="local_status.php" class="btn btn-success" style="margin: 5px;">ABRIR LOCAL</a>';
              }else{
                echo '<a href="local_status.php" class="btn btn-danger" style="margin: 5px;">FECHAR LOCAL</a>';
               }
               }
                ?>
                  ...
                  <div class="card shadow mb-4" > 
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary"><?php echo $local ?></h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
