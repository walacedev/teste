                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <p>Atualmente você tem <b><?php echo $clientesresult->num_rows ?></b> pedidos no local.</p>
                            <p>O produto mais vendido foi: <b><?php
                                                                $itensa = array();
                                                                ...
                                                                if ($result->num_rows > 0) {
                                                                    while ($cli = $result->fetch_assoc()) {
                                                                        $it = json_decode($cli['itens']);
                                                                        foreach ($it as $key) {
                                                                            array_push($itensa, $key->nome);
                                                                        }
                                                                    }
                                                                }
                                                                echo max($itensa) ?></b></p>
                            <p>O segundo mais vendido foi: <b><?php echo max(1, $itensa)[2] ?></b></p>
                            <div class="row">
                                <div style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php function get_endereco($id, $string, $conn)
                                                                {
                                                                ...
                                                                echo get_bairro(get_endereco($pedido['endereco'], 'bairro', $conn), $conn);; ?></td>
                                                            <td>
                                                                <?php
                                                                $total = 0;
