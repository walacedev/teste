...
if ($resultf->num_rows > 0) {
    while ($usuario = $resultf->fetch_assoc()) {
        ...
        $sqlw = "SELECT DISTINCT de FROM pedidos where restaurante = '{$usuario['restaurante']}'";
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <p>Atualmente você tem <?php echo $clientesresult->num_rows ?> clientes cadastrados</p>
                                    ...
                                    <div class="table-responsive-lg">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $sqlw = "SELECT * FROM pedidos where restaurante = '{$usuario['restaurante']}' GROUP BY de";
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            $visits = 0;
                                                            $ultima = "";
                                                            $sqlw = "SELECT * FROM visita where restaurante = '{$usuario['restaurante']}' and de = '{$clientes['de']}'";
                                                            ...
                                                            $total = 0;
                                                            $totais = array();
                                                            $sqlw = "SELECT * FROM pedidos where status = 'success' and de = '{$clientes['de']}' and restaurante = '{$usuario['restaurante']}'";
                                                            ...
                                                            echo "<td>R$ $total_final</td>";
                                                            echo "<td>$prato</td>";

                                                            ?>
<td><a href="cliente_view.php?id=<?php echo $clientes['de'] ?>">Ver</a></td>
                                                        </tr>
