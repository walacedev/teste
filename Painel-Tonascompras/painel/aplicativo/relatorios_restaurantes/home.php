...
if ($resultf->num_rows > 0) {
    while ($usuario = $resultf->fetch_assoc()) {
        ...
        $sqlw = "SELECT DISTINCT de FROM pedidos where status ='success' and restaurante = '{$usuario['restaurante']}'";
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Relátorios</h1>
