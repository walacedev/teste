                                ...
                                <br><div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><?php
                                                                        $sqlw = "SELECT * FROM estados where id = '{$pedido['estado']}'";
                                                                        $resulta = $conn->query($sqlw);
                                                                        if ($resulta->num_rows > 0) {
                                                                            while ($pp = $resulta->fetch_assoc()) {
                                                                                echo $pp['nome'];
                                                                            }
                                                                        }
                                                                        ?></td>
                                                                <td><a href="app/cidade_delete.php?id=<?php echo $pedido['id']; ?>">Excluir</a></td>
                                                            </tr>
                                                    <?php }
                                                    } ?>
                                            ...
                                            <hr class="sidebar-divider d-none d-md-block">
                                            <h4>Criar novo</h4>
                                            <form action="app/cidade_create.php" method="post">
                                                <div class="form-groups">
                                                    <div>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="estado" id="de">
                                                                    <?php
                                                                    $sqlw = "SELECT * FROM estados";
                                                                    $result = $conn->query($sqlw);
                                                                    if ($result->num_rows > 0) {
