                            ...
                            <div id="content">
                                ...
                                <br><div class="container-fluid">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        <h1 class="h3 mb-0 text-gray-800">Campanha</h1>
                                    ...
                                    <div class="row">
                                        <div style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <?php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo ($pedido['msg']) ?></td>
                                                                <td><a href="app/campanha_send.php?msg=<?php echo $pedido['msg']; ?>&titulo=<?php echo $pedido['titulo']; ?>">Enviar novamente</a></td>
                                                            </tr>
                                                    <?php }
                                                                    } ?>
                                            ...
                                            <hr class="sidebar-divider d-none d-md-block">
                                            <h4>Criar novo</h4>
                                            <form action="app/campanha_send.php" method="get">
                                                <div class="form-groups">
                                                    <div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="msg" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
