...
$dest = 0;
        ...
        $result = $conn->query($sqlw);
        if ($result->num_rows > 0) {
            while ($destaque = $result->fetch_assoc()) {
               $dest = $destaque['id'];
            }
            }
?>
                            ...
                            <div id="content">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        <h1 class="h3 mb-0 text-gray-800">Destaque de produto</h1>
                                    ...
                                    ?>
                                        ...
                                        <h4>Selecionar produto em destaque</h4>
                                        <form action="app/destaque_criar.php" method="post" enctype="multipart/form-data">
                                            <div class="form-groups">
                                                <div>
                                                    <div class="form-group">
                                                        <label><b>Você quer destacar qual produto?</b></label>
                                                        <select class="form-control" name="id" id="destaque">
                                                            <option value="0" selected>Nenhum</option>
                                                            <?php
                                                            $sqlw = "SELECT * FROM produtos WHERE restaurante = '{$usuario['restaurante']}' order by nome";
                                                    ...
                                                    $(document).ready(function() {
                                                        document.getElementById('destaque').value = Number("<?php echo $dest ?>");
                                        ...
                                        ?>
                                                ...
                                                <h1>Destaque atual <a href="app/destaque_delete.php">Excluir</a></h1>
                                                <br>
                                                <b>Nome: <?php echo $dd['nome'] ?></b>
                                                <br>
                                                <br>
                                                <img src="imgs/<?php echo $dd['img'] ?>" width="500px">
