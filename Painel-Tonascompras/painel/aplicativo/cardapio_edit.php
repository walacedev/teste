...
if ($result->num_rows > 0) {
    while ($usuario = $result->fetch_assoc()) {
        ...
        $sqlw = "SELECT * FROM cardapio WHERE id = '{$_GET['id']}'";
        $result = $conn->query($sqlw);
        if ($result->num_rows > 0) {
            while ($cardapio = $result->fetch_assoc()) {
                ?>
                <!DOCTYPE html>
                <html lang="en">
                                    ...
                                    <div class="row">
                                        <div style="width: 100%;">
                                            <div class="card shadow h-100 py-2" style="padding-left: 10px;padding-right: 10px;">
                                                <h4>Editar <?php echo $cardapio['nome'] ?></h4>
                                                <br>
                                                <form enctype="multipart/form-data" action="app/cardapio_edit_api.php?id=<?php echo $cardapio['id'] ?>" method="post">
                                                    <div class="form-groups">
                                                        <div>
                                                            <div class="form-group">
                                                                <label><b>Nome</b></label>
                                                                <input type="text" value="<?php echo $cardapio['nome'] ?>" name="nome" class="form-control" placeholder="TVs">
                                                            </div>
                                                            <div class="form-group">
                                                                <label><b>Descrição</b></label>
                                                                <input type="text" value="<?php echo $cardapio['descricao'] ?>" name="desc" class="form-control" placeholder="TVs Smart">
                                                            </div>
