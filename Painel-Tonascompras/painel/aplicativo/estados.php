                                    ...
                                    ?>
                                        ...
                                        <div class="row">
                                            <div style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="app/estado_delete.php?id=<?php echo $pedido['id']; ?>">Excluir</a>&nbsp;&nbsp;<a href="estado_edit.php?id=<?php echo $pedido['id']; ?>">Editar</a></td>
                                                                </tr>
                                                        <?php }
                                                        } ?>
                                                    </tbody>
                                                ...
                                                <hr class="sidebar-divider d-none d-md-block">
                                                <h4>Criar novo</h4>
                                                <form action="app/estado_create.php" method="post">
