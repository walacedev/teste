                                    ...
                                    <div class="card shadow h-100 py-2" style="padding-left: 10px;padding-right: 10px;">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php
                                                $total = 0;
                                                $sqlw = "SELECT * FROM funcionarios where restaurante = '{$usuario['restaurante']}'";
                                                ...
                                                ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $pedido['login'] ?></td>
                                                                <td><?php echo $pedido['senha'] ?></td>
                                                                <td><a href="painel_api/funcionario_delete.php?id=<?php echo $pedido['id'] ?>">Excluir</a>&nbsp;&nbsp;<a href="funcionarios_edit.php?id=<?php echo $pedido['id'] ?>">Editar</a></td>
                                                            </tr>
                                        ...
                                        <hr class="sidebar-divider d-none d-md-block">
                                        <h4>Criar novo</h4>
                                        <form action="painel_api/funcionario_create.php" method="post">
                                            <div class="form-groups">
                                                <div>
                                                <input type="text" name="restaurante" class="form-control" value="<?php echo $usuario['restaurante'] ?>" style="display: none">
                                                    <div class="form-group">
                                                        <label><b>Nome</b></label>
                                                        <input type="text" name="nome" class="form-control" placeholder="João da Silva">
                                                    </div>
                                                    <div class="form-group">
