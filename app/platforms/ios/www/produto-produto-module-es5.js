(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["produto-produto-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProdutoProdutoPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProdutoProdutoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProdutoPageModule", function () {
    ...
    var _produto_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./produto.page */
    ...
    ProdutoPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppProdutoProdutoPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProdutoProdutoPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProdutoPage", function () {
      return ProdutoPage;
    });
    /* harmony import */
    ...
    let ProdutoPage = class ProdutoPage {
      constructor(route, router, http, alertCtrl, navCtrl, loadingController, zone, platform) {
        ...
        this.menuarray_new = [];
        this.restaurante = [];
        this.NUMBER_REGEXP = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/; //TIPOS: 1 = ADICIONAL | 2 = COMPLEMENTO | 3 = PRODUTO | 4 = OPÇÕES

        this.limit = [];
        this.checked = []; //Adds the checkedbox to the array and check if you unchecked it
                  ...
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        id = this.router.url.replace('/produto/', '');
                        this.http.get(new _config__WEBPACK_IMPORTED_MODULE_5__["Config"]().local_link_api + '/api/produto/' + id, {}, {}).then(data => {
                          ...
                          datajson.forEach(addc => {
                            if (addc['prevalecer'] != undefined) {
                              ...
                              this.adicionaisitem.push({
                                nome: addc['nome'],
                                de: addc['de'],
                                descricao: addc['descricao'],
                                id: addc['id'],
                                preco: addc['preco'],
                                isChecked: false,
                                quantidade: 0,
                                gratuito: addc['gratuito']
                              });
      ...
      categorias_gratuitos(id, gratuito) {
        ...
        this.adicionaisitem.forEach(addc => {
          {
            if (addc['de'] == id) {
              if (gratuito == 0 || gratuito == null) {} else {
                adicionais_pr.push(addc);
              }
            }
          }
      ...
      addcart() {
        ...
        this.itens.push({
          ...
          adicionais: this.final,
          adicionais_prev: this.final_prev,
          adicionais_gratis: this.final_gratuito,
          id: this.product['id'],
    ...
    ProdutoPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-produto',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./produto.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/produto/produto.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./produto.page.scss */
      "./src/app/produto/produto.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_2__["HTTP"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["LoadingController"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"]])], ProdutoPage);
    /***/
  }
}]);
//# sourceMappingURL=produto-produto-module-es5.js.map