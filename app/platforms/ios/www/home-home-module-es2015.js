    ...
    rout(string) {
        ...
        this.restaurantes.forEach(e => {
            if (string == e['id']) {
                ...
                if (datauser != null) {
                    this.http.get(new _config__WEBPACK_IMPORTED_MODULE_4__["Config"]().local_link_api + '/api/visita?restaurante=' + e['id'] + '&de=' + datauser['id'], {}, {}).then((data) => {
                    }).catch((err) => {
                        //this.alert_erro("erro", "", err)
                    });
                }
        ...
        this.zone.run(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.navCtrl.navigateForward('/cardapio/' + string);
        }));
    }
    sendmail() {
